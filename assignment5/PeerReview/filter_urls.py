...
def append_prefix(matches: list, base=None):
    """
   Append appropriate prefix to list of urls

   Arguments
   ---------
   matches: The list of matches to append prefixes to.
   ...
   Raises
   ------
   TypeError : if 'base_url' is not str
   """
...
def find_urls(raw_html, base_url=None, output=None):
    ...
    append_prefix(matches, base=base_url)
